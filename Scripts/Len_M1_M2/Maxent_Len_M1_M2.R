...
# RESOLUTION TESTING WITH 10 FOLD CV - not for actual use and only for resolution testing
...
#################################################################################################################################
# dont need to do this because this is if you want to fold it manually but maxent does it automatically with the replicates option
# arb outliers M2
...
# maxent model
# maxent model with 10 replicates in cross validation scenario with giving us jackknifing and percentage contribution to the variables used
...
ArbModM1 <- maxent(predictors, ArbDFM1, args=c("-J","-P",'replicates=10'), 
                  path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/ArbMod_M1")

TerrModM1 <- maxent(predictors, TerrDFM1, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/TerrMod_M1")

AquaModM1 <- maxent(predictors, AquaDFM1, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/AquaMod_M1")

CaveModM1 <- maxent(predictors, CaveDFM1, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/CaveMod_M1")

FossModM1 <- maxent(predictors, FossDFM1, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/FossMod_M1")

SaxModM1 <- maxent(predictors, SaxDFM1, args=c("-J","-P",'replicates=10'), 
                  path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/SaxMod_M1")

#################################################################################################################################

ArbModM2 <- maxent(predictors, ArbDFM2, args=c("-J","-P",'replicates=10'), 
                  path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/ArbMod_M2")

TerrModM2 <- maxent(predictors, TerrDFM2, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/TerrMod_M2")

AquaModM2 <- maxent(predictors, AquaDFM2, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/AquaMod_M2")

CaveModM2 <- maxent(predictors, CaveDFM2, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/CaveMod_M2")

FossModM2 <- maxent(predictors, FossDFM2, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/FossMod_M2")

SaxModM2 <- maxent(predictors, SaxDFM2, args=c("-J","-P",'replicates=10'), 
...
# arboreal prediction - project to the globe and find the mean and save that as a raster
...
writeRaster(ArbPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/ArbMod_prediction_Lenient'), overwrite=T)
...
writeRaster(TerrPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/TerrMod_prediction_lenient'), overwrite=T)
...
writeRaster(AquaPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/AquaMod_prediction_lenient'), overwrite=T)
...
writeRaster(CavePredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/CaveMod_prediction_lenient'), overwrite=T)
...
writeRaster(FossPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/FossMod_prediction_lenient'), overwrite=T)
...
writeRaster(SaxPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/SaxMod_prediction_lenient'), overwrite=T)
...
writeRaster(ArbPredictionM1Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/ArbMod_prediction_M1'), overwrite=T)
...
writeRaster(TerrPredictionM1Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/TerrMod_prediction_M1'), overwrite=T)
...
writeRaster(AquaPredictionM1Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/AquaMod_prediction_M1'), overwrite=T)
...
writeRaster(CavePredictionM1Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/CaveMod_prediction_M1'), overwrite=T)
...
writeRaster(FossPredictionM1Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/FossMod_prediction_M1'), overwrite=T)
...
writeRaster(SaxPredictionM1Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/SaxMod_prediction_M1'), overwrite=T)
...
writeRaster(ArbPredictionM2Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/ArbMod_prediction_M2'), overwrite=T)
...
writeRaster(TerrPredictionM2Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/TerrMod_prediction_M2'), overwrite=T)
...
writeRaster(AquaPredictionM2Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/AquaMod_prediction_M2'), overwrite=T)
...
writeRaster(CavePredictionM2Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/CaveMod_prediction_M2'), overwrite=T)
...
writeRaster(FossPredictionM2Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/FossMod_prediction_M2'), overwrite=T)
...
writeRaster(SaxPredictionM2Average, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/SaxMod_prediction_M2'), overwrite=T)
