...
#resolution
DirtModL <- maxent(predictors, DirtDFL, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/DirtMod_lenient_CV_4")

VegModL <- maxent(predictors, VegDFL, args=c("-J","-P",'replicates=10'), 
                  path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/VegMod_lenient_CV_4")
...
RockModS <- maxent(predictors, RockDFS, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/RockMod_strict")

WaterModS <- maxent(predictors, WaterDFS, args=c("-J","-P",'replicates=10'), 
...
RockModL <- maxent(predictors, RockDFL, args=c("-J","-P",'replicates=10'), 
                   path="./Analysis_Scripts/Chapter3/ENM/Maxent_Files/RockMod_lenient")

WaterModL <- maxent(predictors, WaterDFL, args=c("-J","-P",'replicates=10'), 
...
writeRaster(DirtPredictionSAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/DirtMod_prediction_strict'), overwrite=T)
...
writeRaster(VegPredictionSAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/VegMod_prediction_strict'), overwrite=T)
...
writeRaster(RockPredictionSAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/RockMod_prediction_strict'), overwrite=T)
...
writeRaster(WaterPredictionSAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/WaterMod_prediction_strict'), overwrite=T)
...
writeRaster(DirtPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/DirtMod_prediction_lenient'), overwrite=T)
...
writeRaster(RockPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/RockMod_prediction_lenient'), overwrite=T)
...
writeRaster(WaterPredictionLAverage, paste0('./Analysis_Scripts/Chapter3/ENM/Prediction/WaterMod_prediction_lenient'), overwrite=T)
